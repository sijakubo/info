...
1.  **Open the source code and start editing!**
    ...
    Open the `julia-starter` directory in your code editor of choice and edit `src/pages/index.js` or `src/pages/topic.js`. Save your changes and the browser will update in real time!
