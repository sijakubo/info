...
<h1 align="center">
  Simon Jakubowski blog based on Gatsby Starter Julia
</h1>
...
1.  **Open the source code and start editing!**
    ...
    Open the `julia-starter` directory in your code editor of choice and edit `src/pages/index.js` or `src/pages/notes.js`. Save your changes and the browser will update in real time!
